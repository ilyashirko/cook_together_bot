...
from .bot_processing.main_functions import (get_recipe, main_page,
                                            view_random_dish_preview, view_full_recipe)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        dish_types = [dish_type.title for dish_type in get_dish_types_objects()]
